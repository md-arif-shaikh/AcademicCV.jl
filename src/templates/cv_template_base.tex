...
\raggedright
{\small
<%#department%><%#department-website%>\href{\detokenize{<%&department-website%>}}{<%&department%>}<%/department-website%><%^department-website%><%&department%><%/department-website%>\\<%/department%>
<%#institute%><%#institute-website%>\href{\detokenize{<%&institute-website%>}}{<%&institute%>}<%/institute-website%><%^institute-website%><%&institute%><%/institute-website%>\\<%/institute%>
...
<%#website%>\href{\detokenize{<%&website%>}}{<%&website%>}<%/website%>
}
\end{minipage}
